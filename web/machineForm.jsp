    ...
    <head>
        ...
        <script>
            function confirmSupprimer() {
                return confirm("Êtes-vous sûr de vouloir supprimer cette machine ?");
            }
        </script>
    </head>
    <body>
                ...
                <table border="1" class="tab">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a class="bndelete" href="MachineController?op=delete&id=<%=mm.getId()%>"onclick="return confirmSupprimer();">Supprimer</a></td>
                            <td><button class="bnupdate" datamachine-id="<%=mm.getId()%>">Modifier</button></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
